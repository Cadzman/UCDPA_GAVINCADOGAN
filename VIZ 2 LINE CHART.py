...
# Read the data from file using read_csv release_year , 'date_added'  .. parse_dates=["date_added"]...kind='line'  parse_dates=["release_year"]
netdate = pd.read_csv('ucdprojectgc/netflix_titles.csv',parse_dates=["date_added"], index_col="date_added")
...
#last20 = netdate["2000":"2021"]
last20 = netdate["January 1,2015":"January 1,2021"]

# Add the time-series for "relative_temp" to the plot
ax.plot(last20.index, netdate['show_id'])
...
#Add the data
#the plot: use the DataFrame index for the x value and the "relative_temp" column for the y values
...
#eventies = climate_change["1970-01-01":"1979-12-31"]  ***** SUBSET THE TIME PERIOD BEFOREHAND
